...
import com.viewol.common.WxCrawlerConstant;
import com.viewol.common.utils.DateTimeUtils;
import com.viewol.common.utils.ResourceTransferUtils;
import com.viewol.common.utils.SampleHTMLUtils;
import com.viewol.pojo.AppMsgExtInfoObj;
import com.viewol.pojo.ArticleSummaryObj;
import com.viewol.pojo.CommMsgInfoObj;
        ...
        try {
            ...
            if (StringUtils.isNotEmpty(outputPath)) {
                FileUtils.writeStringToFile(new File(getOutputAccountPath(accountName),
                                com.viewol.common.utils.FileUtils.normalizeFileName(title + ".html"))
                        , content, "UTF-8");
            }
